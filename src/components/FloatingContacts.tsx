...
export default function FloatingContacts() {
  ...
  return (
    <div style={{ position: 'fixed', bottom: '24px', right: '24px', display: 'flex', flexDirection: 'column', gap: '14px', zIndex: 9999 }}>
      ...
      <a 
        ...
        style={{
          ...
          boxShadow: '0 6px 20px rgba(18, 49, 40, 0.4)',
          fontSize: '1.25rem'
        }}
        aria-label="Call Atharva Real Infra"
      >
        📞
        <span className="tooltip">Call Advisor (+91 87888 18163)</span>
      </a>
